...
- (void)setupSettingItems {
    self.settingSections = @[
     ...
     [DYYYSettingItem itemWithTitle:@"直播展馆过滤词" key:@"DYYYLiveZGfilterKeywords" type:DYYYSettingItemTypeTextField placeholder:@"不填关闭"], 
...
[DYYYSettingItem itemWithTitle:@"直播评论缩放0.9" key:@"DYYYLiveCommentScale" type:DYYYSettingItemTypeSwitch],
//[DYYYSettingItem itemWithTitle:@"隐藏直播送礼" key:@"DYYYLiveGiftHide" type:DYYYSettingItemTypeSwitch],
[DYYYSettingItem itemWithTitle:@"隐藏直播点赞特效" key:@"DYYYLiveTapEffect" type:DYYYSettingItemTypeSwitch],
[DYYYSettingItem itemWithTitle:@"隐藏直播展馆右侧" key:@"DYYYLiveZGRightHide" type:DYYYSettingItemTypeSwitch],
[DYYYSettingItem itemWithTitle:@"隐藏直播优惠券" key:@"DYYYLiveYHQHide" type:DYYYSettingItemTypeSwitch],
//[DYYYSettingItem itemWithTitle:@"隐藏分享按钮的朋友列表" key:@"DYYYShareBtFriendHide" type:DYYYSettingItemTypeSwitch],
//[DYYYSettingItem itemWithTitle:@"隐藏评论长按的朋友列表" key:@"DYYYCommentPressFriendHide" type:DYYYSettingItemTypeSwitch],
[DYYYSettingItem itemWithTitle:@"测试1" key:@"DYYYtest1" type:DYYYSettingItemTypeSwitch],
[DYYYSettingItem itemWithTitle:@"测试2" key:@"DYYYtest2" type:DYYYSettingItemTypeSwitch],
[DYYYSettingItem itemWithTitle:@"测试3" key:@"DYYYtest3" type:DYYYSettingItemTypeSwitch],
[DYYYSettingItem itemWithTitle:@"测试4" key:@"DYYYtest4" type:DYYYSettingItemTypeSwitch]
        ],
        @[
